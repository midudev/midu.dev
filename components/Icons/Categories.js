...
const Css = () => (
  <React.Fragment>
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
      <path d="M6.5 8C5.673 8 5 7.327 5 6.5S5.673 5 6.5 5 8 5.673 8 6.5 7.327 8 6.5 8zm0-2a.5.5 0 1 0 0 1 .5.5 0 0 0 0-1zM3.5 11C2.673 11 2 10.327 2 9.5S2.673 8 3.5 8 5 8.673 5 9.5 4.327 11 3.5 11zm0-2a.5.5 0 1 0 0 1 .5.5 0 0 0 0-1zM10.5 7C9.673 7 9 6.327 9 5.5S9.673 4 10.5 4s1.5.673 1.5 1.5S11.327 7 10.5 7zm0-2a.5.5 0 1 0 0 1 .5.5 0 0 0 0-1z" />
      <path d="M10 19c-2.655 0-5.155-.874-7.04-2.461a8.543 8.543 0 0 1-2.161-2.701c-.531-1.057-.8-2.18-.8-3.338s.269-2.282.8-3.338A8.543 8.543 0 0 1 2.96 4.461C4.844 2.874 7.344 2 10 2s5.155.874 7.04 2.461a8.543 8.543 0 0 1 2.161 2.701c.531 1.057.8 2.18.8 3.338 0 1.852-.825 2.512-1.597 2.512-.645 0-1.309-.452-1.822-1.239-.324-.497-.666-.771-.963-.771a.576.576 0 0 0-.299.091c-.562.336-.23 1.245.018 1.756.802 1.654.868 3.098.192 4.178-.82 1.31-2.681 1.974-5.53 1.974zm0-16c-4.963 0-9 3.364-9 7.5S5.037 18 10 18c1.366 0 2.474-.159 3.293-.473.649-.249 1.117-.596 1.39-1.032.611-.976.204-2.284-.245-3.21-.96-1.98-.063-2.793.368-3.051a1.57 1.57 0 0 1 .813-.233c.458 0 1.142.213 1.801 1.226.377.579.766.785.984.785.357 0 .597-.608.597-1.512 0-4.136-4.037-7.5-9-7.5z" />
...
const PerformanceIcon = () => (
  <React.Fragment>
    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="20">
      <path d="M5.5 20a.5.5 0 0 1-.457-.703L8.286 12H3.5a.5.5 0 0 1-.354-.854l10-10a.501.501 0 0 1 .811.556l-3.243 7.297H15.5a.5.5 0 0 1 .354.854l-10 10a.499.499 0 0 1-.354.146zm-.793-9h4.348a.5.5 0 0 1 .457.704L7.05 17.243l7.242-7.242H9.944a.5.5 0 0 1-.457-.704l2.462-5.539L4.707 11z" />
    </svg>
    <style jsx>{`
      path {
        fill: orange;
...
export default ({category}) => {
  const {Icon, title} = categories[category] || {}
  if (!Icon) return null
