...
**No hay razón para no empezar a usar ya el atributo `loading="lazy"` en las imágenes y iframes** que estén fuera del área visible del usuario. Si el navegador lo soporta, tendremos de forma muy sencilla mejoras de rendimiento en nuestro sitio... y si no lo soporta, pues seguirá como hasta ahora.
